...
class ControllerPaymentNOCHEX extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['nochex_xmlcollection'])) {
			...
			$data['nochex_xmlcollection'] = $this->config->get('nochex_xmlcollection');
		}
		if (isset($this->request->post['nochex_debug'])) {
			$data['nochex_debug'] = $this->request->post['nochex_debug'];
		} else {
			$data['nochex_debug'] = $this->config->get('nochex_debug');
		}
		
		if (isset($this->request->post['nochex_postage'])) {
			$data['nochex_postage'] = $this->request->post['nochex_postage'];
		} else {
			$data['nochex_postage'] = $this->config->get('nochex_postage');
		}
		
		if (isset($this->request->post['nochex_hide'])) {
			$data['nochex_hide'] = $this->request->post['nochex_hide'];
		} else {
			$data['nochex_hide'] = $this->config->get('nochex_hide');
		}
